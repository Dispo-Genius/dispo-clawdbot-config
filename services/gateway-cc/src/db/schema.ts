...
// Auto-commit configuration per session
export const AUTO_COMMIT_CONFIG_TABLE = `
CREATE TABLE IF NOT EXISTS auto_commit_config (
  session_id TEXT PRIMARY KEY,
  enabled INTEGER NOT NULL DEFAULT 1,
  debounce_ms INTEGER NOT NULL DEFAULT 30000,
...
// Auto-commit job queue
export const AUTO_COMMIT_QUEUE_TABLE = `
CREATE TABLE IF NOT EXISTS auto_commit_queue (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  session_id TEXT NOT NULL,
  task_id TEXT,
...
export const AUTO_COMMIT_QUEUE_STATUS_INDEX = `
CREATE INDEX IF NOT EXISTS idx_auto_commit_queue_status ON auto_commit_queue(status, execute_at)`;

export const AUTO_COMMIT_QUEUE_SESSION_INDEX = `
CREATE INDEX IF NOT EXISTS idx_auto_commit_queue_session ON auto_commit_queue(session_id)`;

...
import {
  ...
  AUTO_COMMIT_CONFIG_TABLE,
  AUTO_COMMIT_QUEUE_TABLE,
  AUTO_COMMIT_QUEUE_STATUS_INDEX,
  AUTO_COMMIT_QUEUE_SESSION_INDEX,
} from './schema';
...
function migrate(database: Database.Database): void {
  ...
  // Auto-commit configuration and queue
  database.exec(AUTO_COMMIT_CONFIG_TABLE);
  database.exec(AUTO_COMMIT_QUEUE_TABLE);
  database.exec(AUTO_COMMIT_QUEUE_STATUS_INDEX);
  database.exec(AUTO_COMMIT_QUEUE_SESSION_INDEX);
}

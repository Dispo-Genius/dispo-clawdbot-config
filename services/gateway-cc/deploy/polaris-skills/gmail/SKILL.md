...
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail read <message-id>
```

### search
Search emails.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail search "query string"

# Options
--limit <n>       Max results (default 10)

# Examples
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail search "from:someone@example.com"
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail search "subject:meeting after:2024/01/01"
```

### draft
Create a draft email.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail draft --to "recipient@example.com" --subject "Subject" --body "Email body"
...
List draft emails.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail drafts
...
Reply to an email.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec gmail reply <message-id> --body "Reply text"

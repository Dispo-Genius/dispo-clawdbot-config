...
Get issue details.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear get-issue PRO-123
```

### update-status
Update issue status.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear update-status PRO-123 in-progress
...
Update issue fields.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear update-issue PRO-123 \
...
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear create-comment PRO-123 "Comment body"
```

### list-comments
List comments on an issue.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear list-comments PRO-123
```
...
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear create-project "Project Name" --description "Description"
```

### create-document
Create a document attached to an issue or project.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear create-document "Title" "Content" --issue PRO-123
```
...
List documents.
```bash
npx tsx ~/.claude/tools/gateway-cc/src/index.ts exec linear list-documents --issue PRO-123 --title "pattern*"
```
